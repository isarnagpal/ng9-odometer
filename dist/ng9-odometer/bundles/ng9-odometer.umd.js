(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng9-odometer', ['exports', 'lodash', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global['ng9-odometer'] = {}, global.lodash, global.ng.core, global.ng.common));
}(this, (function (exports, lodash, core, common) { 'use strict';

    var Ng9OdometerConfig = /** @class */ (function () {
        function Ng9OdometerConfig() {
    ...
    var Ng9OdometerComponent = /** @class */ (function () {
        function Ng9OdometerComponent() {
            this.config = {};
        ...
        // Start Odometer
        Ng9OdometerComponent.prototype.initOdometer = function () {
        ...
        Ng9OdometerComponent.prototype.initConfig = function () {
            this.config = lodash.defaults(this.config, new Ng9OdometerConfig());
            // Animation
        ...
        //  LIFECYCLES
        // ***************************************
        Ng9OdometerComponent.prototype.ngOnInit = function () {
            var _this = this;
            // Bind Observable
        ...
        Ng9OdometerComponent.prototype.ngOnDestroy = function () {
            if (!lodash.isUndefined(this.subscription)) {
                this.subscription.unsubscribe();
            }
        };
        Ng9OdometerComponent.prototype.ngOnChanges = function () {
            if (!lodash.isUndefined(this.number) && !lodash.isUndefined(this.odometer) && this.config.auto) {
                this.odometer.update(this.number);
            }
        };
        Ng9OdometerComponent.prototype.ngAfterViewInit = function () {
            this.initOdometer();
        };
        Ng9OdometerComponent.ɵfac = function Ng9OdometerComponent_Factory(t) { return new (t || Ng9OdometerComponent)(); };
        Ng9OdometerComponent.ɵcmp = core["ɵɵdefineComponent"]({ type: Ng9OdometerComponent, selectors: [["ng9-odometer"]], viewQuery: function Ng9OdometerComponent_Query(rf, ctx) { if (rf & 1) {
                core["ɵɵviewQuery"](_c0, true, core.ElementRef);
            } if (rf & 2) {
                var _t;
                core["ɵɵqueryRefresh"](_t = core["ɵɵloadQuery"]()) && (ctx.container = _t.first);
            } }, inputs: { number: "number", config: "config", observable: "observable", animation: "animation", format: "format", theme: "theme", value: "value", duration: "duration", auto: "auto" }, features: [core["ɵɵNgOnChangesFeature"]()], decls: 2, vars: 0, consts: [["container", ""]], template: function Ng9OdometerComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        return Ng9OdometerComponent;
    }());
    /*@__PURE__*/ (function () { core["ɵsetClassMetadata"](Ng9OdometerComponent, [{
            type: core.Component,
            args: [{
     ...
     */
    var Ng9OdometerModule = /** @class */ (function () {
        function Ng9OdometerModule() {
        }
        Ng9OdometerModule.forRoot = function () {
            return {
                ngModule: Ng9OdometerModule
            };
        };
        Ng9OdometerModule.ɵmod = core["ɵɵdefineNgModule"]({ type: Ng9OdometerModule });
        Ng9OdometerModule.ɵinj = core["ɵɵdefineInjector"]({ factory: function Ng9OdometerModule_Factory(t) { return new (t || Ng9OdometerModule)(); }, imports: [[common.CommonModule]] });
        return Ng9OdometerModule;
    }());
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && core["ɵɵsetNgModuleScope"](Ng9OdometerModule, { declarations: [Ng9OdometerComponent], imports: [common.CommonModule], exports: [Ng9OdometerComponent] }); })();
    /*@__PURE__*/ (function () { core["ɵsetClassMetadata"](Ng9OdometerModule, [{
            type: core.NgModule,
            args: [{
    ...
    exports.Ng9OdometerComponent = Ng9OdometerComponent;
    exports.Ng9OdometerModule = Ng9OdometerModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng9-odometer.umd.js.map
